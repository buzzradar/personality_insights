...
const DisplayPersonalityData_CTRL = require('../global/DisplayPersonalityData-ctrl');
...
function _renderNav(){
    ...
    $.each(this.navArray, function( index, value ) {
      ...
      ul.append('<li class="nav-item"><a class="'+nav_link_class+'" href="#" data-slug="'+value.slug+'" data-targetdomid="'+value.targetDomId+'" data-url="'+value.url+'">'+value.label+'</a></li>');
    });
