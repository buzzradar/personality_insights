...
function _addSVG(elem) {
    ...
    var imgG = svg.append("g");

    this.tickImg = imgG.append("svg:image")
                // .attr("xlink:href", "assistant_assets/img/tick.png")
                .attr("x", -width/4)
                .attr("y", -height/4)
                .attr("width", width/2)
...
function progressUpdateEnd(objCallback) {
    ...
    if (objCallback.endAngle === 2*Math.PI) {
        ...
        this.tickImg.attr("xlink:href", "images/tick.png");
